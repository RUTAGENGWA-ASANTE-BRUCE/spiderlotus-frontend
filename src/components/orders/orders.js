...
import OneOrderLoader from "./oneOrderLoader";
...
function Orders() {
  ...
  const { userToken, orders } = useContext(AppContext);
    ...
    <div className="w-[80%]">
      <div className="flex flex-col ml-2">
        <h1 className="text-2xl text-black mt-2 ml-1.5 flex flex-row  font-bold">
          Orders <CollectionIcon className="h-7 ml-1 mt-1.5 " />
        </h1>
      ...
      <div className="flex flex-col pt-4 w-full mx-3  bg-white m-auto  pr-2 px-2 mt-4">
        <div className="flex flex-row justify-between border-b-2 pb-2 w-full pr-2">
          <div className=" flex flex-row justify-between gap-x-1  md:gap-x-3 ">
            <div className="flex flex-col">
              ...
              >
                All Orders {orders ? orders.length : ""}
              </h1>
              <div
            ...
            <div className="flex flex-col">
              ...
              >
                Prepared{" "}
                {orders
                  ? orders.filter((order) => order.status === "Prepared").length
                  : ""}
              </h1>
              <div
        ...
        <div className="flex flex-col mt-5 rounded-md mb-2 ">
          <div className="  flex-row h-8 xl:justify-between bg-gray-200 pt-1 px-3 md:flex hidden">
            ...
            <h1 className="text-sm font-semibold w-28 md:ml-1 xl:ml-0 xl:w-24">ADDRESS</h1>
            <h1 className="text-sm font-semibold w-28 md:ml-0.5 xl:ml-0 xl:w-24">PRODUCTS</h1>
